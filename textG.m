...
% Last Modified by GUIDE v2.5 25-Apr-2019 12:09:55
...
% --- Executes just before text is made visible.
function text_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to text (see VARARGIN)

% Choose default command line output for text
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes text wait for user response (see UIRESUME)
